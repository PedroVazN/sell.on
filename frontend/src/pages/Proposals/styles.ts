...
export const ViewToggleBtn = styled.button<{ $active?: boolean }>`
  ...
  border-radius: 8px;
  border: 1px solid ${({ theme }) => theme.colors.border.primary};
  background: ${({ theme, $active }) => ($active ? theme.colors.primary : theme.colors.background.card)};
...
export const KanbanColumn = styled.div<{ $isOver?: boolean }>`
  flex: 0 0 280px;
  min-width: 280px;
  background: ${({ theme }) => theme.colors.background.secondary || '#1e293b'};
  border: 1px solid ${({ theme }) => theme.colors.border.primary};
  border-radius: 12px;
  padding: 12px;
  border-top: 4px solid ${({ $isOver }) => ($isOver ? '#3b82f6' : '#475569')};
  transition: border-color 0.2s;
`;
...
export const KanbanCards = styled.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  min-height: 120px;
...
export const KanbanCard = styled.div<{ $isDragging?: boolean }>`
  padding: 12px;
  background: ${({ theme }) => theme.colors.background.card};
  border: 1px solid ${({ theme }) => theme.colors.border.primary};
  border-radius: 8px;
