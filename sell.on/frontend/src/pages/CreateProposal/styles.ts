...
export const PropostaGifOverlay = styled.div`
  position: fixed;
  inset: 0;
...
export const PropostaGifCard = styled.div`
...
export const PropostaGifMessage = styled.div`
  color: #ffffff;
  font-size: 1.35rem;
  font-weight: 800;
  margin-bottom: 0.75rem;
...
export const PropostaGifImage = styled.img`
  width: 100%;
  height: auto;
  max-height: 66vh;
  object-fit: contain;
